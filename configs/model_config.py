...
MODEL_REGISTRY: Dict[str, ModelConfig] = {
    ...
    "AnchorSeg": ModelConfig(
        model_name="AnchorSeg",
        model_key="AnchorSeg",
        model_class="AnchorSeg",
        # model_file="model/UGround.py",
        model_file="model/AnchorSeg.py",
        description="Original AnchorSeg model for reasoning segmentation",
        default_params={}  # No default params to avoid conflicts
    ),
}
