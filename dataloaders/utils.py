...
ANSWER_LIST = [
    ...
    "Sure, the segmentation result is [SEG].",
    "[SEG].",
    "Sure, {class_name} [SEG].", # newly add
    "Sure, {class_name}:[SEG].",
    "Sure, {class_name} is [SEG].",
    "Sure, the mask of {class_name} is [SEG].",
    "Sure, the mask of {class_name} [SEG].",
    "Sure, the mask of {class_name}:[SEG].",
    "Sure, the segmentation of {class_name} is [SEG].",
    "Sure, the segmentation of {class_name} [SEG].",
    "Sure, the segmentation of {class_name}:[SEG].",
    "Sure, the referred {class_name} is [SEG].",
    "Sure, the referred {class_name} [SEG].",
    "Sure, the referred {class_name}:[SEG].",
]
...
SINGLE_ANSWER_LIST = [
    ...
    "The segmentation result of {class_name} [SEG].",
    "The segmentation result of {class_name}:[SEG].",
    "The mask of {class_name} is [SEG].",
    "The mask of {class_name} [SEG].",
    "The mask of {class_name}:[SEG].",
    "The referred {class_name} is [SEG].",
    "The referred {class_name} [SEG].",
    "The referred {class_name}:[SEG].",
    "[SEG]."
]
...
MULTI_ANSWER_LIST = [
    ...
    "{class_name}:{seg}, separately.",
    "{class_name} {seg}, separately.",
    "{class_name} are {seg}.",
    "{class_name}:{seg}.",
    "{class_name} {seg}.",
    "Sure, {class_name} are {seg}, separately.",
    "Sure, {class_name}:{seg}, separately.",
    "Sure, {class_name} {seg}, separately.",
    ...
    "the segmentation result of {class_name}:{seg}, separately.",
    "the segmentation result of {class_name} {seg}, separately.",
    "Sure, the segmentation result of {class_name} are {seg}.",
    "Sure, the segmentation result of {class_name}:{seg}.",
    "Sure, the segmentation result of {class_name} {seg}.",
